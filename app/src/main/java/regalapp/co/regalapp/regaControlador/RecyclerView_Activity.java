...
public class RecyclerView_Activity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        if (navigateFrom.equals("horizontal")) {
            ...
            getSupportActionBar().setTitle("Mostrando regalos a 1km de tí");
            recyclerView
    ...
    private void populatRecyclerView() {
        ...
        RecyclerView_Adapter adapter = new RecyclerView_Adapter(RecyclerView_Activity.this, arrayList,"vertical");
